  ...
  return (
    <section className="hero-image-grid-section py-5 position-relative overflow-hidden">
      <Container className="my-5">
        ...
        <div className="position-absolute d-none d-sm-block" style={{ top: '30%', left: '8%', width: '110px', height: '110px', zIndex: 1 }}>
          <img src={ModelThree} alt="Model 3" className="img-fluid rounded shadow-sm" style={{ objectFit: 'cover', width: '100%', height: '100%' }} />
        </div>
        <div className="position-absolute d-none d-sm-block" style={{ top: '40%', right: '8%', width: '100px', height: '100px', zIndex: 1 }}>
          <img src={ModelFour} alt="Model 4" className="img-fluid rounded shadow-sm" style={{ objectFit: 'cover', width: '100%', height: '100%' }} />
        </div>
        <div className="position-absolute d-none d-sm-block" style={{ bottom: '10%', left: '15%', width: '120px', height: '120px', zIndex: 1 }}>
        ...
        <Row className="justify-content-center text-center position-relative" style={{ zIndex: 2 }}>
          <Col md={10} lg={8}>
            ...
            <h2 className="display-6 fw-bold mt-4 mb-0" style={{ letterSpacing: '-2px',fontSize: '36px', maxWidth:'1000px'}}>
              Born to Break the pattern
            </h2>
            
            <h2 className="display-6 fw-bold mb-3 text-secondary" style={{ letterSpacing: '-2px', fontSize: '36px', maxWidth:'1000px' }}>
